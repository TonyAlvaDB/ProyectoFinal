...
class Ui_qtWDWRegistroDeArticulos(object):
    def setupUi(self, qtWDWRegistroDeArticulos):
        ...
        self.widget = QtWidgets.QWidget(parent=qtWDWRegistroDeArticulos)
        self.widget.setGeometry(QtCore.QRect(0, 0, 811, 731))
...
"}")
        ...
        self.qtSPNCantidadArticulos = QtWidgets.QSpinBox(parent=self.frame)
        self.qtSPNCantidadArticulos.setGeometry(QtCore.QRect(180, 120, 121, 31))
        self.qtSPNCantidadArticulos.setStyleSheet("background:black")
        self.qtSPNCantidadArticulos.setObjectName("qtSPNCantidadArticulos")
